const lark = require('/home/wz/.openclaw/extensions/openclaw-lark/node_modules/@larksuiteoapi/node-sdk');
const fs = require('fs');
...
async function main() {
  try {
    ...
    // 尝试使用 docx.document.update 接口
    console.log('\n📤 正在更新文档内容...');
    const result = await client.docx.document.update({
      params: {
        document_id: DOC_ID
      },
      data: {
